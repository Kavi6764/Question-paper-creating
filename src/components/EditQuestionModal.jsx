                ...
                <div className="flex-1 overflow-y-auto p-6 space-y-6">
                    ...
                    <div>
                        ...
                        <div className="flex flex-wrap gap-2">
                            {['RE', 'UN', 'AP', 'AN', 'CR', 'EV'].map((level) => (
                                <button
                                    key={level}
                                    onClick={() => setEditedQuestion(prev => ({ ...prev, bloomLevel: level }))}
                                    className={`
                                        px-4 py-2 rounded-lg text-sm font-bold transition-all border-2
                                        ${editedQuestion.bloomLevel === level
                        ...
                        <p className="text-[10px] text-gray-400 mt-2">
                            RE: Remember, UN: Understand, AP: Apply, AN: Analysis, CR: Create, EV: Evaluate
                        </p>
                    </div>
